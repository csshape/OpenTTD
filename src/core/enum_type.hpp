 ...
 */
template <typename Tenum_t, typename Tstorage_t, Tenum_t Tbegin, Tenum_t Tend, Tenum_t Tinvalid, int Tnum_bits = 8 * sizeof(Tstorage_t)>
struct MakeEnumPropsT {
    ...
    static const int num_bits = Tnum_bits;   ///< Number of bits for storing the enum in command parameters
};
