...
typedef __int64_t SQInteger;
typedef __uint64_t SQUnsignedInteger;
typedef __uint64_t SQHash; /*should be the same size of a pointer*/
typedef int SQInt32;
...
typedef __int64_t SQRawObjectVal; //must be 64bits
