...
public:
	/* Priority 10 puts Metal ahead of cocoa-opengl (9), so it is picked first
	 * when the machine has a Metal device; Start() fails cleanly otherwise and
	 * the blitter autoprobe falls through to OpenGL. */
